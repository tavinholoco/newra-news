...
A cobertura end-to-end é separada: **31 specs de Playwright em 5 arquivos**, cobrindo os fluxos de visitante, acervo, conta, newsletter e autorização. Elas rodam contra produção pelo workflow `Smoke E2E` a cada push na `main`, e propositalmente não fazem parte do `pnpm test`.
