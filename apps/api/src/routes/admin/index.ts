 ...
 * Fase 11), e repetir as duas linhas em cada um seria voltar ao hábito por
 ...
 * `adminRoutes` — e alcança `pipeline`, `errors`, `audit` e `sources`, e só
 * eles. A guarda continua a mesma: `authorization-matrix.test.ts` enumera o
